...
macro(_define_relative varname parent subdir docstring)
    ...
    # Check if this is a name from GNUInstallDirs and set _name_in_gnu_dirs accordingly
    ...
    elseif("${_cmakename}" AND NOT _name_in_gnu_dirs)
        # CMake name was given (eg. on the command line) is NOT one of those defined by GNUInstallDirs.
        # This is deprecated.
    ...
    elseif(${_cmakename})
        # CMake name was given (eg. on the command line) and is one of those defined by GNUInstallDirs.
