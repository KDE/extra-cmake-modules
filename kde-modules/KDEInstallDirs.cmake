...
if(WIN32)
  _set_fancy(LIBEXEC_INSTALL_DIR     "${BIN_INSTALL_DIR}"                          "The install dir for libexec executables (default is ${LIB_INSTALL_DIR}/kde4/libexec)")
else()
...
_set_fancy(SYSCONF_INSTALL_DIR       "etc"                                         "The sysconfig install dir (default ${CMAKE_INSTALL_PREFIX}/etc)")
