...
::
  ...
  ecm_setup_qtplugin_macro_names(
      [NAMES <macro_name> [<macro_name> [...]]] # since 6.18
...
``NAMES`` lists the names of C++ preprocessor macros for Qt-style plugins.
...
external files with the plugin metadata. Use ``NAMES`` instead for Qt >= 5.15.
...
macro(ecm_setup_qtplugin_macro_names)
    ...
    set(multiValueArgs NAMES JSON_NONE JSON_ARG1 JSON_ARG2 JSON_ARG3)
    ...
    if(ESQMN_NAMES)
        if(ESQMN_JSON_NONE OR ESQMN_JSON_ARG1 OR ESQMN_JSON_ARG2 OR ESQMN_JSON_ARG3)
            message(FATAL_ERROR "Use either NAMES or any of the JSON_* arguments with ECM_SETUP_QTPLUGIN_MACRO_NAMES()")
        endif()
        set(_macro_names ${ESQMN_NAMES})
    else()
        ...
        if (ECM_GLOBAL_FIND_VERSION VERSION_GREATER_EQUAL 6.18 AND QT_MAJOR_VERSION EQUAL 6)
            message(WARNING "For ECM >= 6.18, use the NAMES argument instead of the JSON_* ones with ECM_SETUP_QTPLUGIN_MACRO_NAMES()")
        endif()
