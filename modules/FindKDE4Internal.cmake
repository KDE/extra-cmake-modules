...
get_filename_component(CMAKE_TOPLEVEL_DIR "${CMAKE_SOURCE_DIR}/.." ABSOLUTE)
string(LENGTH "${CMAKE_TOPLEVEL_DIR}" CMAKE_TOPLEVEL_DIR_LENGTH)

set(KDE4_DEFINITIONS ${_KDE4_PLATFORM_DEFINITIONS} -DQT_NO_STL -DQT_NO_CAST_TO_ASCII -D_REENTRANT -DKDE_DEPRECATED_WARNINGS -DCMAKE_TOPLEVEL_DIR_LENGTH=${CMAKE_TOPLEVEL_DIR_LENGTH})
