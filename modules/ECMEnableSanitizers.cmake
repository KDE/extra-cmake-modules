...
set(_HAVE_CHECK_LINKER FALSE)
if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.18)
    include(CheckLinkerFlag)
    set(_HAVE_CHECK_LINKER TRUE)
endif()
...
if (ECM_ENABLE_SANITIZERS)
    if (CMAKE_CXX_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
        ...
        foreach ( CUR_SANITIZER ${ECM_ENABLE_SANITIZERS} )
            ...
            if(_HAVE_CHECK_LINKER)
                check_linker_flag(CXX "-l${XSAN_LINKER_FLAGS}" _HAVE_XSAN_LINKER_FLAGS)
            endif()
            # check_linker_flag is available only since 3.18, for older CMake versions keep the old behaviour
            if (_HAVE_XSAN_LINKER_FLAGS OR NOT _HAVE_CHECK_LINKER)
