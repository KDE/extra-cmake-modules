...
if( KDEPIMLIBS_INCLUDE_DIR )
  ...
  if (WIN32)
    ...
    find_library(KDE4_KLEO_LIBRARY NAMES kleo PATHS ${KDE4_LIB_DIR} NO_DEFAULT_PATH )
    set(KDE4_KLEO_LIBS ${kleo_LIB_DEPENDS} ${KDE4_KLEO_LIBRARY} )
    ...
    find_library(KDE4_KPGP_LIBRARY NAMES kpgp PATHS ${KDE4_LIB_DIR} NO_DEFAULT_PATH )
    set(KDE4_KPGP_LIBS ${kpgp_LIB_DEPENDS} ${KDE4_KPGP_LIBRARY} )
    ...
    set(KDE4_GPGMEPP_LIBS gpgmepp)
    set(KDE4_KABC_LIBS kabc)
    set(KDE4_KBLOG_LIBS kblog)
    set(KDE4_KCAL_LIBS kcal)
    set(KDE4_KIMAP_LIBS kimap)
    set(KDE4_KLDAP_LIBS kldap)
    set(KDE4_KLEO_LIBS kleo)
    set(KDE4_KMIME_LIBS kmime)
    set(KDE4_KPGP_LIBS kpgp)
    set(KDE4_KPIMIDENTITIES_LIBS kpimidentities)
    set(KDE4_KPIMUTILS_LIBS kpimutils)
    set(KDE4_KRESOURCES_LIBS kresources)
    set(KDE4_KTNEF_LIBS ktnef)
    set(KDE4_KXMLRPCCLIENT kxmlrpcclient)
    set(KDE4_MAILTRANSPORT_LIBS mailtransport)
    set(KDE4_SYNDICATION_LIBS syndication)
    set(KDE4_QGPGME_LIBS qgpgme)
  endif(WIN32)
