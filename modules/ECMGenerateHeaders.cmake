...
function(ECM_GENERATE_HEADERS camelcase_forwarding_headers_var)
    ...
    foreach(_classnameentry ${EGH_HEADER_NAMES})
        ...
        foreach(_CLASSNAME ${_classnames})
            ...
            if (NOT EXISTS ${FANCY_HEADER_FILE})
                file(WRITE ${FANCY_HEADER_FILE} "// IWYU pragma: begin_exports\n")
                file(APPEND ${FANCY_HEADER_FILE} "#include \"${originalprefix}${originalbasename}.${EGH_HEADER_EXTENSION}\"\n")
                file(APPEND ${FANCY_HEADER_FILE} "// IWYU pragma: end_exports\n")
            ...
            if (EGH_PREFIX)
                ...
                if (NOT EXISTS ${REGULAR_HEADER_NAME})
                    file(WRITE ${REGULAR_HEADER_NAME} "// IWYU pragma: begin_exports\n")
                    file(APPEND ${REGULAR_HEADER_NAME} "#include \"${_actualheader}\"\n")
                    file(APPEND ${REGULAR_HEADER_NAME} "// IWYU pragma: end_exports\n")
    ...
    if(EGH_COMMON_HEADER)
        ...
        file(APPEND ${COMMON_HEADER} "// IWYU pragma: begin_exports\n")
        ...
        file(APPEND ${COMMON_HEADER} "// IWYU pragma: end_exports\n")
    endif()
